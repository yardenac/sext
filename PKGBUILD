...
pkgver=0.$(date +%s)
pkgrel=1
ver_sm=2.16.2 #seamonkey
ver_go=19.0 #gecko
ver_ff=19.0.2 #firefox
...
source=("https://static.addons.mozilla.net/_files/309/littlemonkey_for_seamonkey-1.8.76-sm.xpi"
		  ...
		  "https://addons.cdn.mozilla.net/storage/public-staging/220/flashgot-1.5.4.3-sm+tb+fx.xpi"
		  ...
		  "https://addons.cdn.mozilla.net/storage/public-staging/722/noscript-2.6.5.8-sm+fn+fx.xpi"
...
md5sums=("e4280b110334b67fcfc9567100ef7e5b"	# littlemonkey
			...
			"98556a2d2c5441a34e6b4efc638f4ec9"	# flashgot
			...
			"f97258a706d87a28fa7bd8bd4ee05627"	# noscript
...
# last checked for updates: Mar 17 2013
# fireshot
# proxy tool
