...
install=install
pastvers=(2.16 2.16.1 2.16.2 2.17 2.17.1 2.19 2.20 2.21 2.22 2.22.1 2.23 2.24)
source=("https://static.addons.mozilla.net/_files/309/littlemonkey_for_seamonkey-1.8.76-sm.xpi"
		  ...
		  "https://addons.cdn.mozilla.net/storage/public-staging/220/flashgot_mass_downloader-1.5.5.97-fx+sm+tb.xpi"
...
md5sums=("e4280b110334b67fcfc9567100ef7e5b"	# littlemonkey
			...
			"a8133c4bf35527a62f3672235565dfc9"	# flashgot
