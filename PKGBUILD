...
pkgver=0.$(date +%s)
pkgrel=1
ver_sm=2.17.1 #seamonkey
ver_go=20.0 #gecko
ver_ff=20.0.1 #firefox
...
install=install
pastvers=(2.16 2.16.1 2.16.2 2.17)
source=("https://static.addons.mozilla.net/_files/309/littlemonkey_for_seamonkey-1.8.76-sm.xpi"
		  ...
		  "https://addons.cdn.mozilla.net/storage/public-staging/220/flashgot-1.5.5.1-fx+sm+tb.xpi"
		  ...
		  "https://www.eff.org/files/https-everywhere-4.0development.6.xpi"
		  "https://addons.cdn.mozilla.net/storage/public-staging/722/noscript-2.6.5.9-fx+sm+fn.xpi"
...
md5sums=("e4280b110334b67fcfc9567100ef7e5b"	# littlemonkey
			...
			"ff9ac07c84f3b44519a65158e513824c"	# flashgot
			"1e648de48b6f4323a3eaade28486b3c2"	# foxyproxy
			"f441d80dacc34d33f8b7d369c9191ec8"	# google privacy
			"14f55c5b871f697a8d6e1368ca35a612"	# https everywhere
			"ea50b76dd18c1f714359a095b2f00d6a"	# noscript
...
# last checked for updates: Apr 2 2013
# fireshot
# proxy tool
