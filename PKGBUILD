...
source=("https://static.addons.mozilla.net/_files/309/littlemonkey_for_seamonkey-1.8.76-sm.xpi"
		  ...
		  "https://addons.cdn.mozilla.net/storage/public-staging/220/flashgot-1.5.5.2-sm+fx+tb.xpi"
		  ...
		  "https://addons.cdn.mozilla.net/storage/public-staging/722/noscript-2.6.6-sm+fx+fn.xpi"
...
md5sums=("e4280b110334b67fcfc9567100ef7e5b"	# littlemonkey
			...
			"b65f470edc99ea039d86e142654922e9"	# flashgot
			...
			"a018efb1fe0f722ff307382791bf3c98"	# noscript
...
# last checked for updates: Apr 19 2013
# fireshot
# proxy tool
